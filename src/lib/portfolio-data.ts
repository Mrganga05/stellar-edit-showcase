...
export const HERO_VIDEO = V.elephants;
...
export const projects: Project[] = [
  {
    id: "p1", title: "Neon Studio Vlog", category: "YouTube Editing",
    description: "Long-form creator vlog with retention-first pacing.",
    thumb: p1, video: V.bunny,
    overview: "A 14-minute creator vlog re-cut for maximum retention. Tight pacing, layered b-roll, dynamic captions and reactive sound design.",
    techniques: ["J/L audio cuts", "Speed ramps", "Punch-in zooms", "Dynamic captions"],
    results: ["+38% average view duration", "+62% CTR via thumbnail/edit synergy", "3.4M views in 30 days"],
    tools: ["Premiere Pro", "After Effects", "DaVinci Resolve"],
  },
  {
    id: "p2", title: "Athlete Shorts Series", category: "YouTube Shorts",
    description: "9 vertical edits engineered to loop and convert.",
    thumb: p2, video: V.fun,
    overview: "A series of 60-second athlete shorts built to loop. Each edit lands the hook in under 1.2s.",
  ...
  {
    id: "p3", title: "Editorial Reels", category: "Instagram Reels",
    description: "Fashion brand campaign cut for IG-native audiences.",
    thumb: p3, video: V.joy,
  ...
  {
    id: "p4", title: "The Founders Podcast", category: "Podcast Editing",
    description: "Multi-cam podcast edited for clarity and impact.",
    thumb: p4, video: V.escape,
  ...
  {
    id: "p5", title: "Heritage Watch Ad", category: "Business Commercial",
    description: "Premium 30s commercial for a luxury timepiece.",
    thumb: p5, video: V.meltdowns,
  ...
  {
    id: "p6", title: "Coastal Villa Tour", category: "Real Estate Video",
    description: "Listing film for an 8-figure waterfront property.",
    thumb: p6, video: V.sintel,
  ...
  {
    id: "p7", title: "Neon City Frags", category: "Gaming Montage",
    description: "Synced FPS montage with reactive VFX.",
    thumb: p7, video: V.subaru,
  ...
  {
    id: "p8", title: "Golden Hour Wedding", category: "Wedding Film",
    description: "Cinematic 4-minute wedding highlight film.",
    thumb: p8, video: V.tears,
  ...
  {
    id: "p9", title: "Above The Clouds", category: "Cinematic Edit",
    description: "Travel short film with anamorphic grade.",
    thumb: p9, video: V.bunny,
...
export const beforeAfter = [
  { id: "ba1", title: "Color Grading", desc: "Flat log footage transformed into cinematic teal-and-orange.", before: V.bunny, after: V.escape },
  { id: "ba2", title: "Motion Graphics", desc: "Plain talking head elevated with kinetic typography and overlays.", before: V.fun, after: V.joy },
  { id: "ba3", title: "Sound Design", desc: "Raw camera audio mastered with FX, music and dialogue cleanup.", before: V.elephants, after: V.meltdowns },
  { id: "ba4", title: "Transitions & Pace", desc: "Static cuts re-edited with whip, match and seamless transitions.", before: V.sintel, after: V.subaru },
  { id: "ba5", title: "Retention Editing", desc: "Slow intro rebuilt into a hook-first sequence that holds viewers.", before: V.tears, after: V.bunny },
];

export const testimonials = [
  { name: "Marcus Lane", company: "Lane Media · 2.4M subs", quote: "Best editor I've worked with — full stop. Retention jumped immediately and our channel pace doubled.", avatar: a1, rating: 5 },
  { name: "Sofia Martinez", company: "Studio Halo", quote: "Cinematic, fast, communicative. Every deliverable felt premium and on-brand.", avatar: a2, rating: 5 },
  { name: "Rohan Mehta", company: "Founder, Northbeam", quote: "Our ad CVR jumped 58% after switching. This is the bar for high-end video editing.", avatar: a3, rating: 5 },
  { name: "Amara Okafor", company: "Okafor & Co.", quote: "Treated our brand film like it was their own. The grade alone was worth the price.", avatar: a4, rating: 5 },
  { name: "David Klein", company: "Klein Architecture", quote: "Listing film closed the property in under two weeks. The drone work was unreal.", avatar: a5, rating: 5 },
];

export const faqs = [
  { q: "How long does editing take?", a: "Most YouTube long-forms ship within 48–72 hours. Shorts and reels turn around in 24 hours. Larger commercial work is scoped per project." },
  { q: "Do you offer revisions?", a: "Yes — every project includes unlimited revisions within scope until you're genuinely happy with the cut." },
  { q: "What files do you accept?", a: "Raw camera footage, screen recordings, voiceovers, brand assets — uploaded via Frame.io, Dropbox, Google Drive or WeTransfer." },
  { q: "How does payment work?", a: "50% to start, 50% on delivery for project work. Monthly retainers are billed at the start of each cycle. Wire, Stripe, PayPal and UPI all accepted." },
  { q: "Can you handle long-form content?", a: "Absolutely. Long-form podcasts, documentaries and 30+ minute YouTube edits are a core specialty." },
];
